$(document).ready(function () {
  ...
  function checkedFirstLinkWay() {
    if (
      $(".form__inp")
        .val()
        .match(/.+?\@.+/g) &&
      $("#offer-mob").prop("checked") === true &&
      $(".form__inp")
        .val()
        .match(/.+?\..+/g)
    ) {
  ...
  if (
    ...
    if (window.innerWidth <= 540) {
      $("#offer-mob").attr("checked", "true");
      $(".payment").css("display", "none");
      $(".start__mob-block").on("change", function () {
        checkedFirstLinkWay();
      });
      ...
      $(".payment").css("display", "none");
      $(".start__cont-bottom").on("change", function () {
        checkedSecondLinkWay();
      });
      $(".form__inp").on("input", function () {
        checkedSecondLinkWay();
      });
    ...
    if (window.innerWidth <= 540) {
      ...
      $(".start__cont-bottom__left").on("change", function () {
        $("#offer").attr("checked", "true");
        checkedSecond();
      });
      $(".form__inp").on("input", function () {
