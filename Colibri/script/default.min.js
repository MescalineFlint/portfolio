...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var _node_modules_sumoselect_jquery_sumoselect_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/sumoselect/jquery.sumoselect.js */ \"./node_modules/sumoselect/jquery.sumoselect.js\");\n\r\n\r\n\r\njquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {\r\n    \r\n    jquery__WEBPACK_IMPORTED_MODULE_0__(\".basket__card-left-select\").SumoSelect({\r\n    });\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__(\".basket__card-right-btn\").click(function() {\r\n        var x = jquery__WEBPACK_IMPORTED_MODULE_0__(this).parents('.basket__card')\r\n        x.remove()\r\n    })\r\n    \r\n})\n\n//# sourceURL=webpack://gulp/./src/script/basket.js?");

/***/ }),

/***/ "./src/script/catalog.js":
/*!*******************************!*\
  !*** ./src/script/catalog.js ***!
  \*******************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var _node_modules_sumoselect_jquery_sumoselect_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../node_modules/sumoselect/jquery.sumoselect.js */ \"./node_modules/sumoselect/jquery.sumoselect.js\");\n\r\n\r\n\r\njquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.catalog__select').SumoSelect({\r\n    })\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.catalog__reset-btn').click(function(e) {\r\n        e.preventDefault()\r\n        // $('.catalog__select').reset()\r\n\r\n        let selectBox = document.querySelectorAll('.SelectBox')\r\n        let selectPrice = document.getElementById('catalog__select-price').children[0].value\r\n        let selectColor = document.getElementById('catalog__select-color').children[0].value\r\n        let selectNumber = document.getElementById('catalog__select-number').children[0].value\r\n        selectBox[0].children[0].innerHTML = selectPrice\r\n        selectBox[1].children[0].innerHTML = selectColor\r\n        selectBox[2].children[0].innerHTML = selectNumber\r\n    })\r\n\r\n\r\n    let catalogHide = document.querySelectorAll('.catalog__hide')\r\n    let index = 0\r\n    function addViewItem() {\r\n        jquery__WEBPACK_IMPORTED_MODULE_0__('.catalog-btn').click(() => {\r\n            catalogHide[index].style.display = 'flex'\r\n            ++index\r\n        })\r\n    }\r\n    addViewItem()\r\n    \r\n    \r\n    function changePage(url) {\r\n        return fetch(url)\r\n            .then(response => {\r\n                return response.text()\r\n            }).then(data => {\r\n                let r = data\r\n                let container = document.querySelector('.catalog__container')\r\n                let responseDiv= new DOMParser().parseFromString(r, \"text/html\")\r\n                jquery__WEBPACK_IMPORTED_MODULE_0__('.catalog__nav-btn').click(() => {\r\n                    catalogHide[index].style.display = 'flex'\r\n                    container.innerHTML = ' '\r\n                    container.append(responseDiv.children[0])\r\n                })\r\n                \r\n            })\r\n    }\r\n\r\n})\r\n\r\n\n\n//# sourceURL=webpack://gulp/./src/script/catalog.js?");

/***/ }),

/***/ "./src/script/default.js":
/*!*******************************!*\
  !*** ./src/script/default.js ***!
  \*******************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_webpDetected_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/webpDetected.js */ \"./src/script/modules/webpDetected.js\");\n\r\n\r\n_modules_webpDetected_js__WEBPACK_IMPORTED_MODULE_0__.webpDetected.detect();\n\n//# sourceURL=webpack://gulp/./src/script/default.js?");

/***/ }),

/***/ "./src/script/individual.js":
/*!**********************************!*\
  !*** ./src/script/individual.js ***!
  \**********************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var _node_modules_slick_carousel_slick_slick_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../../../../../../../../node_modules/slick-carousel/slick/slick.js */ \"./node_modules/slick-carousel/slick/slick.js\");\n\r\n\r\n\r\njquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.slider__main').slick({\r\n        dots: true,\r\n        speed: 900,\r\n        appendArrows: ('.slider__nav-container'),\r\n        appendDots: ('.slider__nav-container'),\r\n        responsive: [\r\n            {\r\n                breakpoint: 720,\r\n                settings: {\r\n                    arrows: false,\r\n                }\r\n            }, {\r\n                breakpoint: 540,\r\n                settings: {\r\n                    arrows: false,\r\n                    dots: false,\r\n                    autoplay: true,\r\n                    autoplaySpeed: 5000,\r\n                }\r\n            }\r\n        ]\r\n    })\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.slick__slider').slick({\r\n        dots: true,\r\n        centerMode: true,\r\n        centerPadding: '20px',\r\n        slidesToShow: 3,\r\n        slidesToScroll: 1,\r\n        speed: 900,\r\n        responsive: [\r\n            {\r\n                breakpoint: 640,\r\n                settings: {\r\n                    slidesToShow: 1,\r\n                    arrows: false,\r\n                }\r\n            }\r\n        ]\r\n    })\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.search-link').click(function () {\r\n        jquery__WEBPACK_IMPORTED_MODULE_0__('.search-form').toggleClass('visible')\r\n    })\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.header__adaptive-burger').click(function () {\r\n        jquery__WEBPACK_IMPORTED_MODULE_0__('.header__adaptive-menu').toggleClass('active')\r\n    })\r\n\r\n})\n\n//# sourceURL=webpack://gulp/./src/script/main.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\r\n\r\njquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.map').click(function () {\r\n        jquery__WEBPACK_IMPORTED_MODULE_0__('iframe').css(\"pointer-events\", \"auto\");\r\n    })\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('iframe').mouseleave(function() {\r\n        jquery__WEBPACK_IMPORTED_MODULE_0__('iframe').css('pointer-events', 'none');\r\n    }); \r\n})\n\n//# sourceURL=webpack://gulp/./src/script/map.js?");

/***/ }),

/***/ "./src/script/modules/webpDetected.js":
/*!********************************************!*\
  !*** ./src/script/modules/webpDetected.js ***!
  \********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"webpDetected\": () => (/* binding */ webpDetected)\n/* harmony export */ });\nclass webpDetected {\r\n  static detect() {\r\n    const webP = new Image();\r\n    webP.src = 'data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA';\r\n    webP.onload = webP.onerror = function () {\r\n      let className;\r\n      className = webP.height === 2 ?  'webp' : 'no-webp'\r\n      document.documentElement.classList.add('webp')\r\n    }\r\n  }\r\n}\n\n//# sourceURL=webpack://gulp/./src/script/modules/webpDetected.js?");

/***/ }),

/***/ "./src/script/product.js":
/*!*******************************!*\
  !*** ./src/script/product.js ***!
  \*******************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n\r\n\r\njquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function () {\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__(\".product__select\").SumoSelect({\r\n    });\r\n})\n\n//# sourceURL=webpack://gulp/./src/script/product.js?");
...
/******/ 	__webpack_require__("./src/script/basket.js");
/******/ 	__webpack_require__("./src/script/catalog.js");
/******/ 	__webpack_require__("./src/script/default.js");
/******/ 	__webpack_require__("./src/script/individual.js");
/******/ 	__webpack_require__("./src/script/main.js");
/******/ 	__webpack_require__("./src/script/map.js");
/******/ 	var __webpack_exports__ = __webpack_require__("./src/script/product.js");
/******/ 	
/******/ })()
;