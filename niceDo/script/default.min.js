...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var _node_modules_slick_carousel_slick_slick_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../../../node_modules/slick-carousel/slick/slick.min.js */ \"./node_modules/slick-carousel/slick/slick.min.js\");\n/* harmony import */ var _fancyapps_ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @fancyapps/ui */ \"./node_modules/@fancyapps/ui/dist/fancybox.esm.js\");\n\r\n\r\n\r\n\r\njquery__WEBPACK_IMPORTED_MODULE_0__(document).ready(function() {\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.slider').slick({\r\n        dots: true,\r\n        slidesToShow: 7,\r\n        slidesToScroll: 1,\r\n        responsive: [\r\n            {\r\n                breakpoint: 1140, \r\n                settings: {\r\n                    slidesToShow: 5,\r\n                }\r\n            },{\r\n                breakpoint: 860, \r\n                settings: {\r\n                    slidesToShow: 3,\r\n                }\r\n            },{\r\n                breakpoint: 560, \r\n                settings: {\r\n                    arrows: false,\r\n                    slidesToShow: 2,\r\n                }\r\n            }\r\n        ]\r\n    })\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.burger').click(function() {\r\n        jquery__WEBPACK_IMPORTED_MODULE_0__('.burger-menu').toggleClass('show')\r\n    })\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.close-menu').click(function() {\r\n        jquery__WEBPACK_IMPORTED_MODULE_0__('.burger-menu').toggleClass('show')\r\n    })\r\n\r\n\r\n    let lengthCatalog = jquery__WEBPACK_IMPORTED_MODULE_0__('.review__item').length\r\n    let start = 3\r\n    let add = 3\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.review__btn').click(() => {\r\n        if ((start + add) <= lengthCatalog) {\r\n            for (let i = 1; i <= add; i++ ) {\r\n                jquery__WEBPACK_IMPORTED_MODULE_0__('.review__item:nth-child('+ (start + i) +')')[0].style.display = \"flex\"\r\n            }\r\n            start += add\r\n        }\r\n        else {\r\n            jquery__WEBPACK_IMPORTED_MODULE_0__('.review__item:nth-child('+ lengthCatalog +')')[0].style.display = \"flex\"\r\n            jquery__WEBPACK_IMPORTED_MODULE_0__('.show__more').toggleClass('hide')\r\n        }\r\n    })\r\n\r\n\r\n\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.burger__item').click(() => {\r\n        jquery__WEBPACK_IMPORTED_MODULE_0__('.burger-menu').toggleClass('show')\r\n    })\r\n\r\n\r\n    \r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.add-file__label').click(() => {\r\n        jquery__WEBPACK_IMPORTED_MODULE_0__('.price__input').change(function(){\r\n            let nameFile = this.value.split('\\\\')\r\n            jquery__WEBPACK_IMPORTED_MODULE_0__('.add-file__label').text(`${nameFile[nameFile.length-1]}`)\r\n        })\r\n    })\r\n\r\n\r\n    let firstAdress = [45.042438, 39.104275]\r\n    let secondAdress = [45.036884, 39.079796]\r\n    let thirdAdress = [45.043419, 39.112683]\r\n\r\n    function init() {\r\n        let map = new ymaps.Map('map__canvas', {\r\n            center: [45.042438, 39.104275], \r\n            zoom: 10,\r\n            })\r\n            let tokenFirst = new ymaps.Placemark(firstAdress,{\r\n                // balloonContentHeader: 'Название',\r\n                // balloonContentBody: 'Описание',\r\n                // balloonContentFooter: 'Описание',\r\n            },{\r\n                iconLayout: 'default#image',\r\n                iconImageHref: 'images/token-custom.png',\r\n                iconImageSize: [36, 41],\r\n                // iconImageOffset: '',\r\n            })\r\n            let tokenSecond = new ymaps.Placemark(secondAdress, {\r\n                // balloonContentHeader: 'Название',\r\n                // balloonContentBody: 'Описание',\r\n                // balloonContentFooter: 'Описание',\r\n            },{\r\n                iconLayout: 'default#image',\r\n                iconImageHref: '/images/token-custom.png',\r\n                iconImageSize: [36, 41],\r\n                // iconImageOffset: '',\r\n            })\r\n            let tokenThird = new ymaps.Placemark(thirdAdress, {\r\n                // balloonContentHeader: 'Название',\r\n                // balloonContentBody: 'Описание',\r\n                // balloonContentFooter: 'Описание', \r\n            },{\r\n                iconLayout: 'default#image',\r\n                iconImageHref: '/images/token-custom.png',\r\n                iconImageSize: [36, 41],\r\n                // iconImageOffset: '',\r\n            })\r\n\r\n            map.controls.remove('searchControl'); // удаляем поиск\r\n            map.controls.remove('trafficControl'); // удаляем контроль трафика\r\n            map.controls.remove('typeSelector'); // удаляем тип\r\n            map.controls.remove('fullscreenControl'); // удаляем кнопку перехода в полноэкранный режим\r\n            map.controls.remove('rulerControl'); // удаляем контрол правил\r\n            map.behaviors.disable(['scrollZoom']); // отключаем скролл карты (опционально)\r\n\r\n            map.geoObjects.add(tokenFirst)\r\n            map.geoObjects.add(tokenSecond)\r\n            map.geoObjects.add(tokenThird)\r\n            \r\n            jquery__WEBPACK_IMPORTED_MODULE_0__('#map__link-first').click(function(e) {\r\n                e.preventDefault();\r\n                map.setCenter(firstAdress, 18)\r\n            })\r\n            jquery__WEBPACK_IMPORTED_MODULE_0__('#map__link-second').click(function(e) {\r\n                e.preventDefault();\r\n                map.setCenter(secondAdress, 18)\r\n            })\r\n            jquery__WEBPACK_IMPORTED_MODULE_0__('#map__link-third').click(function(e) {\r\n                e.preventDefault();\r\n                map.setCenter(thirdAdress, 18)\r\n            })\r\n        }\r\n    ymaps.ready(init)\r\n\r\n\r\n\r\n    let listLink = document.querySelectorAll('.map__link')\r\n    jquery__WEBPACK_IMPORTED_MODULE_0__('.map__link').click(function(e) {\r\n        e.preventDefault();\r\n        for(let i of listLink) {\r\n            i.style.color = 'var(--colorGreyCA)'\r\n            if(i.id === this.id) {\r\n                this.style.color = 'var(--colorHovRed)'\r\n            }\r\n        }\r\n    })\r\n})\r\n\r\n\r\nconst observer = new IntersectionObserver((entries) => {\r\n    entries.forEach((entry) => {\r\n        if(entry.isIntersecting){\r\n            document.querySelectorAll('.nav__item-link').forEach((link) => {\r\n                let linkItem = link.getAttribute('href').replace('#', '')\r\n                link.classList.toggle('active', linkItem.replace('/', '') === entry.target.id)\r\n            })\r\n        }\r\n    },{\r\n        threshold: .7,\r\n    }) \r\n})\r\ndocument.querySelectorAll('.section').forEach(\r\n    (section) => observer.observe(section)\r\n)\r\nconst observerMob = new IntersectionObserver((entries) => {\r\n    entries.forEach((entry) => {\r\n        if(entry.isIntersecting){\r\n            document.querySelectorAll('.burger__item-link').forEach((link) => {\r\n                let linkItem = link.getAttribute('href').replace('#', '')\r\n                link.classList.toggle('active', linkItem.replace('/', '') === entry.target.id)\r\n            })\r\n        }\r\n    },{\r\n        threshold: .7,\r\n    }) \r\n})\r\ndocument.querySelectorAll('.section').forEach(\r\n    (section) => observerMob.observe(section)\r\n)\r\n\n\n//# sourceURL=webpack://gulp/./src/script/main.js?");
